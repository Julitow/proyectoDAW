...
if($cookieVideo==null){
	echo '<video autoplay preload width="640" height="360">';
		...
		echo '<source src="video/video.webm" type="video/webm"/>';
		echo '<source src="video/video.fvl" type="video/fvl"/>';
		echo '<source src="video/video.avi" type="video/avi"/>';
		echo '<source src="video/video.swf" type="video/swf"/>';
	echo '</video>';
